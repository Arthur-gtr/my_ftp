...
const command_t command_tab[] = {
    ...
    {.command_name = "PORT", .size = 4, .data_transfer =  false, .nb_argument = 1, .funct = &port},
    {.command_name = "PWD",  .size = 3, .data_transfer =  false, .nb_argument = 0, .funct = &pwd},
    {.command_name = "QUIT", .size = 4, .data_transfer =  false, .nb_argument = 0, .funct = &quit},
    {.command_name = "RETR", .size = 4, .data_transfer =  false, .nb_argument = 1, .funct = &retr},
    {.command_name = "STOR", .size = 4, .data_transfer =  false, .nb_argument = 1, .funct = &stor},
